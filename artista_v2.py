...
asociacion = np.array ([[1,2,3,4,5],
                        ["fusiona_2_img","fusiona_varias_imgs","musica_amplitud_a_color","func_cos_a_pix","func_log_a_pix"],
                        ["func_sin_a_pix","hebb_RGB_ind","hebb_RGB_per_pixel","recorta_nxm_flipH","recorta_nxm_flipV"],
                        ["figura_collage","difuminado_gaussiano_random","difuminado_gaussiano_full","apagado_pixel","efecto_zoom"]])
...
while (1):
    ...
    time.sleep(9)
    print (str(info) +": " + str(datetime.datetime.now().time()))
